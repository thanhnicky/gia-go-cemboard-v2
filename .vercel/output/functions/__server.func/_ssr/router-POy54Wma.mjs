...
const appCss = "/assets/styles-2iwj3W9d.css";
...
const $$splitComponentImporter$2 = () => import("./thank-you-BsqttZm_.mjs");
const Route$2 = createFileRoute("/thank-you")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./index-EMjUyxSG.mjs");
const Route$1 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Lotus — hệ sơn giả gỗ chuyên dụng cho tấm xi măng, Smartwood, Conwood, Cemboard, Fiber Cement. Tư vấn đúng hệ cho từng hạng mục, đặt hàng nhanh hoặc nhắn Zalo."
    }, {
      property: "og:title",
      content: "Sơn giả gỗ Lotus cho tấm xi măng"
    }, {
      property: "og:description",
      content: "Biến tấm xi măng thành bề mặt đẹp như gỗ thật. Đặt hàng nhanh hoặc nhắn Zalo để được tư vấn đúng hệ sơn."
    }]
  })
});
const $$splitComponentImporter = () => import("./thank-you._phone-DV_eiSWa.mjs");
const Route2 = createFileRoute("/thank-you/$phone")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const ThankYouRoute = Route$2.update({
  id: "/thank-you",
  path: "/thank-you",
...
const ThankYouPhoneRoute = Route2.update({
  id: "/$phone",
  path: "/$phone",
  getParentRoute: () => ThankYouRoute
});
const ThankYouRouteChildren = {
  ThankYouPhoneRoute
};
